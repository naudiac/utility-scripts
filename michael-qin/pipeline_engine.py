    ...
    * {{
    ...
    @media (max-width: 768px) {{
        ...
        .tab-item.active {{
            ...
            color: #ffffff;
            border-color: var(--corporate-navy);
            box-shadow: 0 1px 3px rgba(15, 39, 68, 0.2);
            margin-bottom: 0;
        }}
        ...
        <div class="intel-drawer" id="intel-drawer">
            ...
            <div class="intel-cheat-grid">
                ...
                <div class="intel-cheat-card" onclick="applyIndustryPreset('medical')">
                    ...
                    <span class="cheat-cue">Pain: 60-90 day insurance reimbursement float</span>
                    <span class="cheat-hook">Hook: "Smooth out insurance claim delays with zero personal collateral."</span>
                </div>
                <div class="intel-cheat-card" onclick="applyIndustryPreset('manufacturing')">
                    <span class="cheat-title">🏭 Manufacturing &amp; Fab</span>
                    <span class="cheat-cue">Pain: Equipment financing ACH + net-60/90 invoice lag</span>
                    <span class="cheat-hook">Hook: "Bridge the invoice cycle gap without payroll risk."</span>
                </div>
                <div class="intel-cheat-card" onclick="applyIndustryPreset('retail')">
                    <span class="cheat-title">🚗 Auto Dealers &amp; Retail</span>
                    <span class="cheat-cue">Pain: Floorplan interest &amp; slow-season daily MCA drain</span>
                    <span class="cheat-hook">Hook: "Consolidate floorplan &amp; working capital into one payment."</span>
                </div>
            </div>
        </div>
    </div>
...
Send it over now, what's your best email?"`,
        ...
        who_is_this_tactical: "State your niche with bulletproof certainty. Drop the social proof bomb ('$7,500/month saved') fast. Lock the 45-second email ask with 'Fair enough?'",
        hook_tactical: "Contingent model = zero risk for them. Pre-handle security fears ('black out the account numbers'). Close on email routing immediately.",
        dont_need_money_tactical: "Flip it: 'I'm not here to borrow, I'm here to audit leakage.' Make finding fee waste feel like found money. Close with 'You'd at least want to know, wouldn't you?'",
        just_email_me_tactical: "Never hang up without the 45-second on-call download ask. Invoke urgency: 'I'll confirm receipt on the line RIGHT NOW.'",
...
What if you just black out the account numbers before you send it? We only need to see the deposits and debits to run the math. Would it be impossible to send that over to a secure link?"`,
        ...
        who_is_this_tactical: "Use a 'Would it be ridiculous...' No-oriented question to disarm. Mirror their skepticism back to them. Never push — let them feel heard first.",
        hook_tactical: "Label their skepticism ('It seems like you're skeptical...'). Then flip the framing — you run the audit on YOUR dime. Ask 'How does that sound?'",
        dont_need_money_tactical: "Label their confidence ('It sounds like you have it dialed in'). Then drill down with a calibrated question to reveal hidden pain.",
        just_email_me_tactical: "Acknowledge their busyness with empathy. Ask a 'How' question: 'How am I supposed to run a real analysis if I just send a generic brochure?'",
    ...
    "klaff_frame": {{
        ...
        opener: `"[Name], Michael Qin from the private credit desk at Creative Capital. I have a hard stop in exactly two minutes for a committee meeting, but I wanted to drop a quick metric on your desk.
...
I need to jump on this next call in 60 seconds. Where should I send the secure upload link?"`,
        dont_need_money: `"[Name], the guys who 'need money' are exactly the guys we reject. We don't lend to distressed operators.
...
If you're happy paying retail rates to your current lender, keep doing it. But if you want to know what institutional pricing looks like for [Company], let's run the audit. What email?"`,
        just_email_me: `"[Name], I don't send out blind marketing decks. They're a waste of your time and mine.
...
Are you in front of your computer or should we just part ways here?"`,
        what_rates: `"[Name], my desk doesn't throw darts at a dartboard. Our institutional rates are tied directly to your operating revenue. 
...
Are we doing this or should I move on to my next call?"`,
        ...
        statement_pushback: `"[Name], we evaluate $50M a month in commercial paper. Your financials are completely secure with my underwriters. 
...
I'm sending the secure portal link now, what's your email?"`,
        ...
        who_is_this_tactical: "Establish your status: 50 files/week, only take clients where math works. Make THEM qualify. End with 'I don't know if [Company] qualifies yet.'",
        hook_tactical: "Hard time constraint ('60 seconds'). Prize frame: the data does the work, not you. Make it feel like a privilege to get your team's eyes on their file.",
        dont_need_money_tactical: "Flip the prize: 'The guys who NEED money are who we REJECT.' Position them as a prime company who simply pays retail rates they shouldn't.",
        just_email_me_tactical: "Don't beg. Assert: 'I don't send blind decks.' Give them a binary choice — pull the statements right now or part ways. Hold the frame.",
    ...
    "cardone_10x": {{
        ...
        opener: `"[Name]! Michael Qin, Creative Capital Solutions. We are slashing daily loan debits for [Industry] operators right now, moving guys out of expensive [Lender_Or_Default] positions and cutting payments by 40%.
...
I'm going to send you a quick email right now so you have my contact info. What's the best email for you, [Name]?"`,
        hook: `"Great. Look [Name], I know you're busy, I'm busy too, that's exactly why I called.
...
Shoot those over to me while we're on the phone, what email are you sending from?"`,
        dont_need_money: `"I agree with you completely [Name], you don't need money, you need to KEEP your money!
...
What email?"`,
        ...
        who_is_this_tactical: "High energy, assumptive. Drop the social proof fast. Immediately ask for the email — treat it as the natural next step, not a close.",
        hook_tactical: "Agree with everything, then push right through. 'I know you're busy, me too, that's EXACTLY why I called.' Give them zero time to object.",
        dont_need_money_tactical: "Instantly agree ('I agree completely!') then flip it: 'You don't need money, you need to KEEP your money!' Pivot to the audit ask with zero hesitation.",
        just_email_me_tactical: "Agree you'll email. Then immediately push through: 'While I have you...' Make the 45-second download sound like the fastest possible path forward.",
    ...
    "challenger_sale": {{
        ...
        opener: `"[Name], Michael Qin with the private credit desk at Creative Capital.
...
I'd like to send you our recent white-paper analysis on this, along with a secure link to run a free audit on your last 3 statements. What's your direct email?"`,
        hook: `"[Name], the biggest risk to [Company] right now isn't lack of capital, it's the cost of the capital you already deployed.
...
We typically uncover $3k to $5k a month in margin leakage. Where should I send the audit framework?"`,
        dont_need_money: `"Most operators think they're all set, [Name]—until we show them how their current lender is front-loading the interest and bleeding their daily cash flow.
...
Send me the 3 statements. Let us prove it mathematically. What email?"`,
        just_email_me: `"I can send the email, [Name]. But let's be pragmatic.
...
You can redact the account numbers. We just need the raw data to prove they're overcharging you. What email?"`,
        ...
        who_is_this_tactical: "Lead with the market insight: true cost of capital is 45% not 15% due to daily debit factoring. Position yourself as the expert who will prove it mathematically.",
        hook_tactical: "Reframe from 'need for capital' to 'cost of existing capital.' Their biggest risk is what they already owe. The audit proves it. Make that feel urgent.",
        dont_need_money_tactical: "Challenge their certainty: 'How sure are you that your effective rate is under 18%?' Create constructive tension by questioning their status quo assumption.",
        just_email_me_tactical: "Make the cost of waiting tangible: 'Tomorrow morning you'll get hit with another expensive debit you didn't need to pay.' Urgency through consequence.",
...
I want to send you the exact case study of how we just saved a competitor of yours $7,500 a month. What's the best email to send that to?"`,
        hook: `"[Name], right now we have an exclusive block of institutional capital specifically earmarked to refinance operators in [Industry], but it closes at the end of the month.
...
What email should I use?"`,
        dont_need_money: `"I'm glad to hear that [Name], because the operators who get approved for our lowest rates are exactly the ones who don't *need* the money.
...
Let's run the 3-statement audit to see what rate tier you actually qualify for. What's your email?"`,
        just_email_me: `"I can email you [Name], but the operators who secure these rates don't wait on emails—they run the 45-second audit with me live on the phone so we can get them into underwriting today.
...
What email?"`,
        ...
        statement_pushback: `"I completely understand the caution. That's why the top firms in [Industry] trust us—we run a completely secure, in-house audit. 
...
What's the best email?"`,
        ...
        who_is_this_tactical: "Drop social proof immediately: '80% of companies your size are overpaying.' Send the case study. Position yourself as the expert who just fixed their competitor.",
        hook_tactical: "Scarcity: exclusive capital block closing end of month. Consensus: 'The top firms run this quarterly.' Make the audit feel like the industry standard.",
        dont_need_money_tactical: "Flip the social proof: 'The operators approved for our LOWEST rates are the ones who don't need money.' They should WANT to qualify, not run from the call.",
        just_email_me_tactical: "Authority + social proof: 'The operators who secure these rates don't wait on emails — they run the audit live on the phone.' Make it feel like the smart money move.",
    ...
    "ziglar_relational": {{
        ...
        opener: `"Hey [Name], I hope you're having a good day. It's Michael Qin with Creative Capital Solutions.
...
I'd love to just send you a quick note with my contact info so you know I'm a real person. What's the best email for you?"`,
        hook: `"[Name], I treat my clients the way I'd want my own family treated. If you share your last 3 bank statements with me, I will personally look them over.
...
What email works best for you?"`,
        dont_need_money: `"I completely understand how you feel, [Name]. A lot of our best clients felt the exact same way when I first called them.
...
Let me do a quick, free check on your last 3 statements. What email should I use?"`,
        just_email_me: `"I'd be happy to send you an email [Name]. But you know how it is—we all get busy, and things just pile up on the desk.
...
Who do you guys bank with down there, Chase or Wells Fargo?"`,
        what_rates: `"[Name], I'd love to give you a number right now, but I want to be completely honest with you—if I guess, I might be wrong, and I don't want to make a promise I can't keep. 
...
Let's start small. What's your email?"`,
        ...
        who_is_this_tactical: "Build trust: 'We helped a guy just like you hire two new people.' Make them feel like a person, not a prospect. Position as a concerned advisor, not a salesman.",
        hook_tactical: "Fiduciary frame: 'I'll personally look them over. If your lender is fair, I'll tell you to stay.' Build the relationship first. The deal follows trust.",
        dont_need_money_tactical: "Feel, Felt, Found: 'I completely understand how you feel. Our best clients FELT the same way. What they FOUND was thousands in hidden fees.' Then ask for email gently.",
        just_email_me_tactical: "Frame around family time: 'Let's get this off your plate so you don't have to deal with paperwork tonight.' Personal, protective, warm close.",
...
function setTone(toneKey, btn) {{
    ...
    const profile = TONE_PROFILES[toneKey] || TONE_PROFILES["belfort_straight_line"];
...
const INDUSTRY_PRESETS = {{
    "contractor": {{
        ...
        revenue: "$140,000/mo",
        debitStr: "$1,850/day ($40K/mo)",
        notes: "Pain: 60-90 day GC progress draw lag while daily debits drain payroll.",
        painHook: "stop daily debits while waiting on 60-day GC progress draws",
        calcRev: 140000,
        calcDebit: 40000,
        calcNewPay: 14500,
        calcAdvance: 175000
    ...
    "trucking": {{
        ...
        revenue: "$185,000/mo",
        debitStr: "$2,400/day ($52K/mo)",
        notes: "Pain: Diesel fuel card debits & 45-day freight broker payables lag.",
        painHook: "bridge slow freight broker payables without predatory factoring cuts",
        calcRev: 185000,
        calcDebit: 52000,
        calcNewPay: 18000,
        calcAdvance: 225000
    ...
    "restaurant": {{
        ...
        revenue: "$95,000/mo",
        debitStr: "$950/day ($21K/mo)",
        notes: "Pain: POS credit card batch holds; wants to keep 100% of weekend receipts.",
        painHook: "keep 100% of your busy weekend credit card receipts",
        calcRev: 95000,
        calcDebit: 21000,
        calcNewPay: 8500,
        calcAdvance: 110000
    ...
    "medical": {{
        ...
        revenue: "$130,000/mo",
        debitStr: "$1,200/day ($26K/mo)",
        notes: "Pain: 60-day Medicare & private insurer reimbursement lag.",
        painHook: "smooth out 60-day insurance reimbursement float with zero personal collateral",
        calcRev: 130000,
        calcDebit: 26000,
        calcNewPay: 11000,
        calcAdvance: 160000
    ...
    "manufacturing": {{
        ...
        revenue: "$260,000/mo",
        debitStr: "$3,600/day ($78K/mo)",
        notes: "Pain: High raw material prepayments & CNC equipment lease debt.",
        painHook: "bridge the invoice cycle gap without payroll risk on Net-90 terms",
        calcRev: 260000,
        calcDebit: 78000,
        calcNewPay: 26000,
        calcAdvance: 320000
    ...
    "retail": {{
        ...
        revenue: "$110,000/mo",
        debitStr: "$1,350/day ($29K/mo)",
        notes: "Pain: Seasonal inventory buildup & parts supplier invoices.",
        painHook: "consolidate floorplan interest and slow-season daily MCA drain into one payment",
        calcRev: 110000,
        calcDebit: 29000,
        calcNewPay: 10500,
        calcAdvance: 135000
...
function applyIndustryPreset(key) {{
    ...
    // Auto-sync Savings Calculator with Vertical Benchmarks
    if (p.calcRev && document.getElementById('calc-rev')) document.getElementById('calc-rev').value = p.calcRev;
    if (p.calcDebit && document.getElementById('calc-debit')) document.getElementById('calc-debit').value = p.calcDebit;
    if (p.calcNewPay && document.getElementById('calc-new-pay')) document.getElementById('calc-new-pay').value = p.calcNewPay;
    if (p.calcAdvance && document.getElementById('calc-advance')) document.getElementById('calc-advance').value = p.calcAdvance;
    runCalc();
...
function formatWithTokens(templateStr, highlight = false) {{
    ...
    if (leadState.lender.trim()) {{
        ...
        res = res.replaceAll("[Lender_Or_Default]", `${{lenderToken}} or high-factor daily positions`);
    }} else {{
        res = res.replaceAll("[Lender_Or_Default]", "OnDeck, Rapid, or other high-factor daily MCA positions");
    }}
    ...
    if (leadState.revenue.trim()) {{
        ...
        res = res.replaceAll("[Revenue_Or_Default]", "mid-market operators in your sector");
    }}

    if (leadState.notes.trim()) {{
        const painClean = leadState.notes.replace(/^Pain:\s*/i, '');
        res = res.replaceAll("[Vertical_Pain]", painClean);
    }} else {{
        res = res.replaceAll("[Vertical_Pain]", "high daily debits and compounding factor fees");
    }}
...
function getActiveNodeData(nodeKey) {{
    const profile = TONE_PROFILES[currentToneKey] || TONE_PROFILES["belfort_straight_line"];
    ...
    const baseMap = {{
        ...
        "who_is_this": {{
            ...
            tactical: profile.who_is_this_tactical,
            options: [
        ...
        "aligned_hook": {{
            ...
            tactical: profile.hook_tactical,
            options: [
        ...
        "dont_need_money": {{
            ...
            tactical: profile.dont_need_money_tactical,
            options: [
        ...
        "just_email_me": {{
            ...
            tactical: profile.just_email_me_tactical,
            options: [
...
function deleteCustomDeck(id, e) {{
    ...
    renderCustomDeckList();
    renderToneChips();
    if (currentToneKey === id) setTone('belfort_straight_line');
}}
...
function renderObjections() {{
    ...
    const profile = TONE_PROFILES[currentToneKey] || TONE_PROFILES["belfort_straight_line"];
        ...
        {{
            title: `🚫 "We don't need money / We're all set"`,
            rebuttal: profile.dont_need_money,
            principle: profile.dont_need_money_tactical || "Reframe from borrowing to expense reduction and cash recovery."
        }},
        {{
            title: `📧 "Just email me info / I'm busy"`,
            rebuttal: profile.just_email_me,
            principle: profile.just_email_me_tactical || "Never let them off the phone without asking for the 45-second on-call download."
        }},
        {{
            title: `🏷️ "What are your rates / factor rates?"`,
            rebuttal: profile.what_rates,
            principle: profile.what_rates_tactical || "Never quote a blind number; trade rate clarity for statements."
        }},
        {{
            title: `🔒 "Why do you need bank statements? / I don't send docs"`,
            rebuttal: profile.statement_pushback,
            principle: profile.statement_pushback_tactical || "Offer account number redaction to instantly eliminate security friction."
        }},
        {{
            title: `❓ "Who is this / What company?"`,
            rebuttal: profile.who_is_this,
            principle: profile.who_is_this_tactical || "State your niche, reference peer results, and close for their direct email."
        }},
        {{
            title: `💸 "I already have 2 loans with OnDeck taking $1,800/day"`,
            rebuttal: `\"That is exactly why I am calling [Name]. We specialize in taking high-factor daily positions out of [Lender_Or_Default] and rolling them into a single, clean monthly facility that cuts your debt drain by 40%. All I need is your trailing 3 months of business statements to model the exact monthly cash we put back in [Company]'s operating account.\"`,
            principle: "The golden consolidation lead! Never treat existing debt as a rejection — treat it as your highest-converting opportunity."
        }}
    ];

    container.innerHTML = `
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px; background:#eff6ff; border:1px solid #bfdbfe; border-radius:4px; padding:6px 10px;">
            <div>
                <span style="font-size:11.5px; font-weight:800; color:#1e40af;">🎭 Active Methodology: ${{profile.name}}</span>
                <span style="font-size:11px; color:#2563eb; margin-left:8px; font-weight:700;">• Vertical: ${{formatWithTokens("[Industry]")}}</span>
            </div>
            <span style="font-size:10px; color:#3b82f6; font-family:var(--mono); font-weight:700;">⚡ Live Synced</span>
        </div>
        ...
        <div style="margin-bottom: 8px; border-bottom: 1px solid var(--border-subtle); padding-bottom: 6px;">
            ...
            <div class="copy-block red-box">
                <div class="copy-text">${{formatWithTokens(o.rebuttal, true)}}</div>
                <button class="btn-copy" onclick="copySnippet(this)">Copy</button>
            </div>
            <div style="font-size: 10.5px; color: var(--text-muted); margin-top: 2px; line-height: 1.35;">
                <strong style="color:var(--corporate-navy);">🎯 Principle (${{profile.name}}):</strong> ${{o.principle}}
            </div>
        </div>
    `).join('');
}}
...
function renderPipeline() {{
    ...
    const stagesData = [
        {{
            ...
            goal: "Identify active commercial operators in [Industry] with daily/weekly MCA positions, high processing volume, or upcoming refinancing events.",
            script: "Always verify business name, state of filing, and approximate monthly volume before dialing.",
            actions: [
        ...
        {{
            num: 2,
            title: `The 30-Second Disarm & Hook (${{profile.name}})`,
            goal: "Disarm the merchant in 5 seconds, frame call as expense reduction, and establish high-status authority.",
            script: profile.opener,
            tactical: profile.tactical,
            actions: [
                "Execute the tone-specific opening verbatim.",
        ...
        {{
            num: 3,
            title: `45-Second On-Call Statement Extraction (${{profile.name}})`,
            goal: "Keep merchant on the line and walk them through downloading 3 months of bank statements right now.",
            script: profile.just_email_me,
            tactical: profile.just_email_me_tactical,
            actions: [
        ...
        {{
            ...
            goal: "Model the consolidated cash flow savings showing exact monthly dollars freed up for [Company].",
            script: `"We completed the preliminary debt audit for [Company]. By consolidating your daily positions out of [Lender_Or_Default], we free up +$10,500/month in net cash flow, saving $126,000 this year."`,
            actions: [
        ...
        {{
            ...
            goal: "Walk through the numbers on a 10-minute call, address prepayment/fee questions, and get signed acceptance.",
            script: `"1. Recap merchant's stated cash crunch
...
4. Ask: 'Based on these numbers, does it make sense to lock this in today?'"`,
        ...
        {{
            ...
            goal: "Clear stipulations, coordinate closing call, and confirm wire disbursement into merchant account.",
            script: `"All stipulations cleared for [Company]. Wire has been released and will reflect in your checking account within 2 hours."`,
            actions: [
        ...
        {{
            ...
            goal: "Solidify lifetime advisory relationship and collect 2 peer merchant introductions in [Industry].",
            script: `"Hey [Name], congratulations again on funding! We freed up +$10,500/month in operating cash for [Company]. Who are 1 or 2 other business owners in [Industry] who are getting squeezed by high daily fees and could use a quick cash flow check like this?"`,
            actions: [
    ...
    container.innerHTML = `
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px; background:#eff6ff; border:1px solid #bfdbfe; border-radius:4px; padding:6px 10px;">
            <div>
                ...
                <span style="font-size:11px; color:#2563eb; margin-left:8px; font-weight:700;">• Target: ${{formatWithTokens("[Industry]")}}</span>
            </div>
            <span style="font-size:10px; color:#3b82f6; font-family:var(--mono); font-weight:700;">⚡ Live Synced</span>
        </div>
        ...
        <div style="margin-bottom: 10px; border-bottom: 1px solid var(--border-subtle); padding-bottom: 8px;">
            ...
            ${{s.script ? `
                <div class="copy-block green-box" style="margin-bottom:4px;">
                    <div style="font-size:9.5px; font-weight:700; color:var(--color-success); text-transform:uppercase; margin-bottom:2px;">Verbatim Script</div>
                    <div class="copy-text">${{formatWithTokens(s.script, true)}}</div>
                    <button class="btn-copy" onclick="copySnippet(this)">Copy</button>
                </div>
            ` : ''}}
            ${{s.tactical ? `
                <div style="font-size:10.5px; color:var(--text-muted); margin-bottom:4px;">
                    <strong style="color:var(--corporate-navy);">🎯 Tactical Focus:</strong> ${{s.tactical}}
                </div>
            ` : ''}}
            <div style="font-size: 10.5px; color: var(--text-muted); margin-bottom: 2px;"><strong>Key Actions:</strong></div>
            <ul style="padding-left: 14px; font-size: 10.5px; color: var(--text-main); line-height:1.4;">
                ${{s.actions.map(a => `<li>${{formatWithTokens(a)}}</li>`).join('')}}
            </ul>
        </div>
    `).join('');
}}
