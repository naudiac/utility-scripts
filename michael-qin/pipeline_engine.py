...
High-Clarity, Color-Coded Tactical Edition.
Engineered for instant visual recognition on Autodialers, iPhone, and Android.
"""
...
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&family=JetBrains+Mono:wght@600;800&display=swap" rel="stylesheet">
<style>
    :root {{
        --bg-base: #0a0c10;
        --bg-surface: #11141c;
    ...
    * {{
    ...
    .btn-nav:hover {{ background: #252e42; color: #fff; }}

    /* =========================================================================
       COLOR CODED STATEMENT HUBS & TABS
       ========================================================================= */
    .card {{
        background: var(--bg-surface);
        border: 1px solid var(--border);
    ...
    .copy-box.green-box {{ border-left-color: var(--c-green); }}
    .copy-box.red-box {{ border-left-color: var(--c-red); }}
    .copy-box.yellow-box {{ border-left-color: var(--c-yellow); }}
    ...
    .btn-copy:hover {{ color: #fff; border-color: var(--c-blue); }}
    ...
    @media print {{
        header, .nav-tabs, .btn-nav, .btn-copy {{ display: none !important; }}
...
<header>
    <div class="header-inner">
        ...
        <div class="hotkey-legend">
            Keys: [1-6] Reactions | [Space] Copy Line | [R] Reset
        </div>
    </div>
</header>
...
I work on the commercial capital placement side, and the reason for the call is simple: we are working with merchants in your industry right now to lower their daily/weekly debits and clean up expensive debt."</div>
            ...
            <div class="hud-foot">
                ...
                <div style="display: flex; gap: 6px; margin-left: auto;">
                    <button class="btn-nav" onclick="copyText(document.getElementById('hud-verbatim').innerText)">📋 Copy Line (Space)</button>
    ...
    <div id="tab-statement" class="tab-pane">
        <div class="card">
            ...
            <div class="copy-box green-box">
                ...
                <div class="copy-text">"John, are you in front of your computer or looking at your phone right now?
...
3. "Download the last 3 monthly PDFs and forward directly to my email."</div>
        ...
        <div class="card">
            ...
            <div class="copy-box yellow-box">
                <div class="copy-text">"John, I don't want you wasting your evening downloading statements if this doesn't put money back into your business.
...
Let me send you a secure request link right now. What's the best email?"</div>
    ...
    <div id="tab-cadence" class="tab-pane">
        <div class="card">
            ...
            <div class="copy-box green-box">
                <div class="copy-text">"Hi [Name], Michael Qin here from Capital Advisory. Great speaking with you briefly. To run your debt consolidation and statement audit, just email your last 3 monthly business bank PDFs to michael@capitaladvisory.com. Once received, I will have your approved numbers back within 24 hours."</div>
                <button class="btn-copy" onclick="copySnippet(this)">Copy</button>
            </div>
            ...
            <div class="copy-box yellow-box">
                <div class="copy-text">Subject: Quick question regarding [Business Name] cash flow
...
Michael Qin</div>
            ...
            <div class="copy-box red-box">
                <div class="copy-text">Subject: Closing your file / [Business Name]
...
def main():
    ...
    print(f"[+] Successfully generated color-coded portal: {portal_html_path}")
