...
ThinkAutomation Corporate Navy & Executive Slate Edition (Matching v83 Architecture Style).
"""
...
<style>
    ...
    * {{
    ...
    /* Corporate Document Header (ThinkAutomation Style) */
    .doc-header {{
    ...
    /* Response Options Grid (ThinkAutomation Color Tags) */
    .options-label {{
        font-size: 11px;
        font-weight: 700;
        color: var(--text-muted);
    ...
    @media print {{
        .tabs-nav, .btn-ctrl, .btn-copy, .btn-clear, .btn-share-hdr, .modal-overlay {{ display: none !important; }}
    ...
    <div class="doc-header">
        ...
        <div class="lead-grid">
            <div class="meta-cell">
                ...
                <input type="text" id="lead-name" class="meta-input" placeholder="e.g. John" oninput="updatePersonalization()">
            </div>
            <div class="meta-cell">
                <span class="meta-label">Merchant / Company Name</span>
                <input type="text" id="lead-company" class="meta-input" placeholder="e.g. Apex Logistics" oninput="updatePersonalization()">
            </div>
            <div class="meta-cell">
                <span class="meta-label">Industry / Operating Niche</span>
                <input type="text" id="lead-industry" class="meta-input" placeholder="e.g. Trucking / Freight" oninput="updatePersonalization()">
            </div>
...
def main():
    ...
    print(f"[+] Successfully generated ThinkAutomation-styled portal: {portal_html_path}")
