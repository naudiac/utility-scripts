        ...
        <div class="intel-drawer" id="intel-drawer">
            ...
            <div class="intel-cheat-grid">
                ...
                <div class="intel-cheat-card" onclick="applyIndustryPreset('medical')">
                    ...
                    <div class="intel-card" id="ic-manufacturing">
                        <div class="intel-card-header" onclick="toggleIntelCard('ic-manufacturing')">
                            Manufacturing
                        </div>
                        <div class="intel-card-body">
                            <div class="intel-pain">Pain: Equipment ACH debits + net-60/90 invoice lag create daily cash gaps even with strong revenue.</div>
                            <div class="intel-hook">Hook: We bridge the gap between your invoice cycle and daily ACH — no payroll risk waiting on Net-90 terms.</div>
                        </div>
                    </div>
                    <div class="intel-card" id="ic-auto">
                        <div class="intel-card-header" onclick="toggleIntelCard('ic-auto')">
                            Auto and Retail
                        </div>
                        <div class="intel-card-body">
                            <div class="intel-pain">Pain: Floorplan interest + daily MCA debits compound during slow months (Jan-Feb, Aug).</div>
                            <div class="intel-hook">Hook: We consolidate floor-plan and working capital into one clean monthly payment — no more daily drain in the slow season.</div>
                        </div>
                    </div>
    </div>
