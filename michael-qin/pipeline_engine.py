    ...
    <div class="arena-grid">
        ...
        <div class="arena-card">
            <div class="card-head">
                ...
                <span style="font-size: 9.5px; color: var(--muted);">Live Coaching</span>
            </div>
            ...
            <div class="timer-block">
                ...
                <div class="timer-ctrls">
                    <button class="btn-t start" onclick="startTimer()">▶ Start</button>
                    <button class="btn-t pause" onclick="pauseTimer()">⏸ Pause</button>
                    <button class="btn-t reset" onclick="resetTimer()">↺ Reset</button>
                </div>
            </div>
            ...
            <div class="rubric-row">
                ...
                <div class="rubric-grid">
                    <button class="rubric-pill red" onclick="setRubric('tone', 'Rushed / Timid', 'red', this)">🔴 Timid</button>
                    <button class="rubric-pill amber" onclick="setRubric('tone', 'Conversational', 'amber', this)">🟡 Casual</button>
                    <button class="rubric-pill green" onclick="setRubric('tone', 'Wall St Authority', 'green', this)">🟢 Authority</button>
                </div>
            </div>
            ...
            <div class="rubric-row">
                ...
                <div class="rubric-grid">
                    <button class="rubric-pill red" onclick="setRubric('deflect', 'Caved to Email', 'red', this)">🔴 Caved</button>
                    <button class="rubric-pill amber" onclick="setRubric('deflect', 'Soft Push', 'amber', this)">🟡 Soft</button>
                    <button class="rubric-pill green" onclick="setRubric('deflect', '45s Download Lock', 'green', this)">🟢 45s Lock</button>
                </div>
            </div>
            ...
            <div class="rubric-row">
                ...
                <div class="rubric-grid">
                    <button class="rubric-pill red" onclick="setRubric('stmt', 'No Ask / Blank', 'red', this)">🔴 No Ask</button>
                    <button class="rubric-pill amber" onclick="setRubric('stmt', 'Vague Email Ask', 'amber', this)">🟡 Vague</button>
                    <button class="rubric-pill green" onclick="setRubric('stmt', 'Redaction + 4PM Lock', 'green', this)">🟢 Redact+Lock</button>
                </div>
            </div>
...
🎯 SCORECARD:
• Tone & Frame Control: ${{activeRubric.tone || 'Not Graded'}}
